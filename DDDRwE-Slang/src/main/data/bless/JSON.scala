...
// This file is auto-generated from MISSING_AADL_TYPE.scala, Base_Types.scala, DataContent.scala, Aux_Types.scala
...
object JSON {
  ...
  object Printer {
    ...
    @pure def printMissingMISSING_AADL_TYPE(o: Missing.MISSING_AADL_TYPE): ST = {
      return printObject(ISZ(
        ("type", st""""Missing.MISSING_AADL_TYPE"""")
      ))
    }

    @pure def printMissingMISSING_AADL_TYPE_Payload(o: Missing.MISSING_AADL_TYPE_Payload): ST = {
      return printObject(ISZ(
        ("type", st""""Missing.MISSING_AADL_TYPE_Payload""""),
        ("value", printMissingMISSING_AADL_TYPE(o.value))
      ))
    }
    ...
    @pure def print_artDataContent(o: art.DataContent): ST = {
      o match {
        ...
        case o: Missing.MISSING_AADL_TYPE_Payload => return printMissingMISSING_AADL_TYPE_Payload(o)
      }
    }
  ...
  @record class Parser(val input: String) {
    ...
    def parseMissingMISSING_AADL_TYPE(): Missing.MISSING_AADL_TYPE = {
      val r = parseMissingMISSING_AADL_TYPET(F)
      return r
    }

    def parseMissingMISSING_AADL_TYPET(typeParsed: B): Missing.MISSING_AADL_TYPE = {
      if (!typeParsed) {
        parser.parseObjectType("Missing.MISSING_AADL_TYPE")
      }
      return Missing.MISSING_AADL_TYPE()
    }

    def parseMissingMISSING_AADL_TYPE_Payload(): Missing.MISSING_AADL_TYPE_Payload = {
      val r = parseMissingMISSING_AADL_TYPE_PayloadT(F)
      return r
    }

    def parseMissingMISSING_AADL_TYPE_PayloadT(typeParsed: B): Missing.MISSING_AADL_TYPE_Payload = {
      if (!typeParsed) {
        parser.parseObjectType("Missing.MISSING_AADL_TYPE_Payload")
      }
      parser.parseObjectKey("value")
      val value = parseMissingMISSING_AADL_TYPE()
      parser.parseObjectNext()
      return Missing.MISSING_AADL_TYPE_Payload(value)
    }
    ...
    def parse_artDataContent(): art.DataContent = {
      ...
      t.native match {
        ...
        case "Missing.MISSING_AADL_TYPE_Payload" => val r = parseMissingMISSING_AADL_TYPE_PayloadT(T); return r
        case _ => val r = parseMissingMISSING_AADL_TYPE_PayloadT(T); return r
      }
    }
  ...
  def fromMissingMISSING_AADL_TYPE(o: Missing.MISSING_AADL_TYPE, isCompact: B): String = {
    val st = Printer.printMissingMISSING_AADL_TYPE(o)
    if (isCompact) {
  ...
  def toMissingMISSING_AADL_TYPE(s: String): Either[Missing.MISSING_AADL_TYPE, Json.ErrorMsg] = {
    def fMissingMISSING_AADL_TYPE(parser: Parser): Missing.MISSING_AADL_TYPE = {
      val r = parser.parseMissingMISSING_AADL_TYPE()
      return r
    }
    val r = to(s, fMissingMISSING_AADL_TYPE _)
    return r
  }

  def fromMissingMISSING_AADL_TYPE_Payload(o: Missing.MISSING_AADL_TYPE_Payload, isCompact: B): String = {
    val st = Printer.printMissingMISSING_AADL_TYPE_Payload(o)
    if (isCompact) {
      return st.renderCompact
    } else {
      return st.render
  ...
  def toMissingMISSING_AADL_TYPE_Payload(s: String): Either[Missing.MISSING_AADL_TYPE_Payload, Json.ErrorMsg] = {
    def fMissingMISSING_AADL_TYPE_Payload(parser: Parser): Missing.MISSING_AADL_TYPE_Payload = {
      val r = parser.parseMissingMISSING_AADL_TYPE_Payload()
      return r
    }
    val r = to(s, fMissingMISSING_AADL_TYPE_Payload _)
    return r
  }
