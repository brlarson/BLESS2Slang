...
@datatype class Config_MissingMISSING_AADL_TYPE(attempts: Z, verbose: B, filter: Missing.MISSING_AADL_TYPE => B) {}

@datatype class Config_MissingMISSING_AADL_TYPE_Payload(attempts: Z, verbose: B, filter: Missing.MISSING_AADL_TYPE_Payload => B) {}
