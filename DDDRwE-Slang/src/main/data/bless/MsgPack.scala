...
object MsgPack {
  ...
  object Constants {
    ...
    val MissingMISSING_AADL_TYPE: Z = -32

    val MissingMISSING_AADL_TYPE_Payload: Z = -31
  ...
  @msig trait Writer {
    ...
    def writeMissingMISSING_AADL_TYPE(o: Missing.MISSING_AADL_TYPE): Unit = {
      writer.writeZ(Constants.MissingMISSING_AADL_TYPE)
    }

    def writeMissingMISSING_AADL_TYPE_Payload(o: Missing.MISSING_AADL_TYPE_Payload): Unit = {
      writer.writeZ(Constants.MissingMISSING_AADL_TYPE_Payload)
      writeMissingMISSING_AADL_TYPE(o.value)
    }
    ...
    def write_artDataContent(o: art.DataContent): Unit = {
      o match {
        ...
        case o: Missing.MISSING_AADL_TYPE_Payload => writeMissingMISSING_AADL_TYPE_Payload(o)
      }
    }
  ...
  @msig trait Reader {
    ...
    def readMissingMISSING_AADL_TYPE(): Missing.MISSING_AADL_TYPE = {
      val r = readMissingMISSING_AADL_TYPET(F)
      return r
    }

    def readMissingMISSING_AADL_TYPET(typeParsed: B): Missing.MISSING_AADL_TYPE = {
      if (!typeParsed) {
        reader.expectZ(Constants.MissingMISSING_AADL_TYPE)
      }
      return Missing.MISSING_AADL_TYPE()
    }

    def readMissingMISSING_AADL_TYPE_Payload(): Missing.MISSING_AADL_TYPE_Payload = {
      val r = readMissingMISSING_AADL_TYPE_PayloadT(F)
      return r
    }

    def readMissingMISSING_AADL_TYPE_PayloadT(typeParsed: B): Missing.MISSING_AADL_TYPE_Payload = {
      if (!typeParsed) {
        reader.expectZ(Constants.MissingMISSING_AADL_TYPE_Payload)
      }
      val value = readMissingMISSING_AADL_TYPE()
    ...
    def read_artDataContent(): art.DataContent = {
      ...
      t match {
        ...
        case Constants.MissingMISSING_AADL_TYPE_Payload => val r = readMissingMISSING_AADL_TYPE_PayloadT(T); return r
        case _ =>
          reader.error(i, s"$t is not a valid type of art.DataContent.")
          val r = readMissingMISSING_AADL_TYPE_PayloadT(T)
          return r
      }
    }
  ...
  def fromMissingMISSING_AADL_TYPE(o: Missing.MISSING_AADL_TYPE, pooling: B): ISZ[U8] = {
    val w = Writer.Default(MessagePack.writer(pooling))
    w.writeMissingMISSING_AADL_TYPE(o)
    return w.result
  }

  def toMissingMISSING_AADL_TYPE(data: ISZ[U8]): Either[Missing.MISSING_AADL_TYPE, MessagePack.ErrorMsg] = {
    def fMissingMISSING_AADL_TYPE(reader: Reader): Missing.MISSING_AADL_TYPE = {
      val r = reader.readMissingMISSING_AADL_TYPE()
      return r
    }
    val r = to(data, fMissingMISSING_AADL_TYPE _)
    return r
  }

  def fromMissingMISSING_AADL_TYPE_Payload(o: Missing.MISSING_AADL_TYPE_Payload, pooling: B): ISZ[U8] = {
    val w = Writer.Default(MessagePack.writer(pooling))
    w.writeMissingMISSING_AADL_TYPE_Payload(o)
    return w.result
  }

  def toMissingMISSING_AADL_TYPE_Payload(data: ISZ[U8]): Either[Missing.MISSING_AADL_TYPE_Payload, MessagePack.ErrorMsg] = {
    def fMissingMISSING_AADL_TYPE_Payload(reader: Reader): Missing.MISSING_AADL_TYPE_Payload = {
      val r = reader.readMissingMISSING_AADL_TYPE_Payload()
      return r
    }
    val r = to(data, fMissingMISSING_AADL_TYPE_Payload _)
    return r
  }
