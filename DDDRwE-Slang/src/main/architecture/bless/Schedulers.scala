...
object Schedulers {
  ...
  val PG_imp_Instance_pgp_ddd_timingProperties: ThreadTimingProperties = ThreadTimingProperties(
    computeExecutionTime = None(),
    domain = None())

  val PG_imp_Instance_pgp_rc_timingProperties: ThreadTimingProperties = ThreadTimingProperties(
    computeExecutionTime = None(),
    domain = None())

  val PG_imp_Instance_pgp_mkr_timingProperties: ThreadTimingProperties = ThreadTimingProperties(
    computeExecutionTime = None(),
    domain = None())

  val PG_imp_Instance_pgp_stg_timingProperties: ThreadTimingProperties = ThreadTimingProperties(
    computeExecutionTime = None(),
    domain = None())
  ...
  val staticSchedule: DScheduleSpec = DScheduleSpec(0, 0, DSchedule(ISZ(
    Slot(Arch.PG_imp_Instance_pgp_ddd.id, maxExecutionTime),
    Slot(Arch.PG_imp_Instance_pgp_rc.id, maxExecutionTime),
    Slot(Arch.PG_imp_Instance_pgp_mkr.id, maxExecutionTime),
    Slot(Arch.PG_imp_Instance_pgp_stg.id, maxExecutionTime)
  )))
