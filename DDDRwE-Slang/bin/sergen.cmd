...
val files: ISZ[String] = ISZ("../src/main/data/bless/Missing/MISSING_AADL_TYPE.scala",
                             "../src/main/data/bless/Base_Types.scala",
                             "../src/main/art/art/DataContent.scala",
                             "../src/main/data/bless/Aux_Types.scala")

val toolargs: String = st"${(files, " ")}".render

proc"$sireum tools sergen -p bless -m json,msgpack -o ${Os.slashDir.up}/src/main/data/bless $toolargs".at(Os.slashDir).console.runCheck()
