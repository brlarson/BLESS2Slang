...
import bless.SystemTestSuiteSlang._
import bless.runtimemonitor.{GumboXDispatcher, ObservationKind, RuntimeMonitor, RuntimeMonitorListener}
...
@msig trait SystemTestSuiteSlang extends RuntimeMonitorListener {
  ...
  override def init(modelInfo: bless.runtimemonitor.ModelInfo): Unit = {
  }
  ...
  override def observeComputePreState(bridgeId: art.Art.BridgeId, observationKind: bless.runtimemonitor.ObservationKind.Type, pre: Option[art.DataContent]): Unit = {
  }
