...
@msig trait DDD_i_ddd_ddd_TestApi {

  def BeforeEntrypoint(): Unit = {
    Art.initTest(Arch.Pacemaker_imp_Instance_ddd_ddd)
  }

  def AfterEntrypoint(): Unit = {
    Art.finalizeTest(Arch.Pacemaker_imp_Instance_ddd_ddd)
  }

  def testCompute(): Unit = {
    Art.manuallyClearOutput()
    Art.testCompute(Arch.Pacemaker_imp_Instance_ddd_ddd)
  }

  def testInitialise(): Unit = {
    Art.manuallyClearOutput()
    Art.testInitialise(Arch.Pacemaker_imp_Instance_ddd_ddd)
  }
   ...
   */
  def check_concrete_output(ap: Z => B,
                            vp: Z => B,
                            as: Z => B,
                            vs: Z => B): Unit = {
  ...
  def put_a(): Unit = {
    ArtNative.insertInInfrastructurePort(Arch.Pacemaker_imp_Instance_ddd_ddd.operational_api.a_Id, Empty())
  }

  // setter for in EventPort
  def put_v(): Unit = {
    ArtNative.insertInInfrastructurePort(Arch.Pacemaker_imp_Instance_ddd_ddd.operational_api.v_Id, Empty())
  }
  ...
  def get_ap_payload(): Option[Empty] = {
    return ArtNative.observeOutInfrastructurePort(Arch.Pacemaker_imp_Instance_ddd_ddd.initialization_api.ap_Id).asInstanceOf[Option[Empty]]
  }
  ...
  def get_vp_payload(): Option[Empty] = {
    return ArtNative.observeOutInfrastructurePort(Arch.Pacemaker_imp_Instance_ddd_ddd.initialization_api.vp_Id).asInstanceOf[Option[Empty]]
  }
  ...
  def get_as_payload(): Option[Empty] = {
    return ArtNative.observeOutInfrastructurePort(Arch.Pacemaker_imp_Instance_ddd_ddd.initialization_api.as_Id).asInstanceOf[Option[Empty]]
  }
  ...
  def get_vs_payload(): Option[Empty] = {
    return ArtNative.observeOutInfrastructurePort(Arch.Pacemaker_imp_Instance_ddd_ddd.initialization_api.vs_Id).asInstanceOf[Option[Empty]]
  }
